                        ...
                        <div class="white-box">
                            <div class="media bg-primary">
                                <div class="media-body">
                                    <h3 class="info-count">0 <span class="pull-right"><i class="fa fa-users"></i></span></h3>
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-success">
                                <div class="media-body">
                                    <h3 class="info-count">5 <span class="pull-right"><i class="fa fa-user"></i></span></h3>
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-danger">
                                <div class="media-body">
                                    <h3 class="info-count">4 <span class="pull-right"><i class="fa fa-bars"></i></span></h3>
                                    <p class="info-text font-12">Class</p>
                    ...
                    <div class="col-md-3 col-sm-6 info-color-box">
                        <div class="white-box">
                            <div class="media bg-warning">
                                <div class="media-body">
                                    <h3 class="info-count">17 <span class="pull-right"><i class="fa fa-book"></i></span></h3>
                                    <p class="info-text font-12">Lessons</p>
